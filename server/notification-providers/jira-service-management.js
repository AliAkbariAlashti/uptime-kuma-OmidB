...
class JiraServiceManagement extends NotificationProvider {
    ...
    async send(notification, msg, monitorJSON = null, heartbeatJSON = null) {
        ...
        const textMsg = "Omid Bank monitoring Alert";

        try {
            if (heartbeatJSON == null) {
                // Test notification
                let notificationTestAlias = "omid-bank-monitoring-notification-test";
                let data = {
                    message: msg,
                    alias: notificationTestAlias,
                    source: "Omid Bank monitoring",
                    priority: "P5",
                    tags: ["Omid Bank monitoring"],
                };
