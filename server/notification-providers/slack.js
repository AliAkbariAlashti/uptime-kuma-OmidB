...
class Slack extends NotificationProvider {
     ...
     * @param {string} baseURL Omid Bank monitoring base URL
    ...
    buildActions(baseURL, monitorJSON) {
        ...
        if (baseURL) {
            actions.push({
                ...
                text: {
                    type: "plain_text",
                    text: "Visit Omid Bank monitoring",
                },
                value: "Omid Bank monitoring",
    ...
    async send(notification, msg, monitorJSON = null, heartbeatJSON = null) {
        ...
        try {
            ...
            const title = monitorJSON?.name || "Omid Bank monitoring Alert";
            let data = {
                text: msg,
                channel: notification.slackchannel,
                username: notification.slackusername,
